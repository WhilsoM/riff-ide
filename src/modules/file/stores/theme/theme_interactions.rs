...
pub struct ThemeInteractionsStore {
    pub bg_main_100: egui::Color32,
    pub bg_main_200: egui::Color32,
    pub bg_main_300: egui::Color32,
    ...
    pub border_primary: egui::Color32,
...
impl ThemeInteractionsStore {
    pub fn new() -> Self {
        Self {
            bg_main_100: egui::Color32::from_rgb(20, 20, 20),
            bg_main_200: egui::Color32::from_rgb(25, 25, 25),
            bg_main_300: egui::Color32::from_rgb(30, 30, 30),
            bg_hover: egui::Color32::from_rgb(45, 45, 45),
            ...
            accent_secondary: egui::Color32::from_rgb(0, 151, 251),
            accent_hover: egui::Color32::from_rgb(0, 100, 180),

            border_primary: egui::Color32::from_rgb(60, 60, 60),
            border_secondary: egui::Color32::from_rgb(50, 50, 50),

            error: egui::Color32::from_rgb(244, 67, 54),
            warning: egui::Color32::from_rgb(255, 152, 0),
            success: egui::Color32::from_rgb(76, 175, 80),
            info: egui::Color32::from_rgb(33, 150, 243),
        }
    }
    ...
    pub fn bg_main_200_style(&self) -> Rc<Style> {
        Rc::new(Style::new().background_color(self.bg_main_200))
    }

    pub fn bg_main_300_style(&self) -> Rc<Style> {
        Rc::new(Style::new().background_color(self.bg_main_300))
    }
...
impl Default for ThemeInteractionsStore {
    fn default() -> Self {
        Self::new()
    }
}
